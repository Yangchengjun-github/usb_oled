...
void GPIO_CONFIG(void)
{
	...
	GPIO_Init(GPIOA0, 12, 0); // USB1
	GPIO_Init(GPIOA0, 11, 0); // USB2
	GPIO_Init(GPIOA0, 10, 0); // USB3
	GPIO_Init(GPIOA0, 9, 0); // USB3

	GPIO_Init(GPIOA0, 2, 0); //RST
	GPIO_Init(GPIOB0, 1, 0);  //DC
	/*SCL SDA开漏*/
	GPIO_OpenDrain_EN(GPIOA0, 14);
...
{
	I2C_DeInit();
	I2C_Master_CONFIG(I2C_SDA_PA014,I2C_SCL_PA015,FAST_MODE,I2C_MASTRER_7BIT,0X3c,0Xa0,0Xa0);//address=0X57,SCL=IIClk*250=5us
